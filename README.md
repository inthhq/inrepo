...
<p align="center">
  <a href="https://www.npmjs.com/package/inrepo"><picture><source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/npm/inrepo.svg?variant=outline&size=xs&mode=dark"><img src="https://shieldcn.dev/npm/inrepo.svg?variant=outline&size=xs&mode=light" alt="Latest NPM Version"></picture></a>
  <a href="https://github.com/inthhq/inrepo"><picture><source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/github/inthhq/inrepo/stars.svg?variant=outline&size=xs&mode=dark"><img src="https://shieldcn.dev/github/inthhq/inrepo/stars.svg?variant=outline&size=xs&mode=light" alt="Stars"></picture></a>
  <a href="https://github.com/inthhq/inrepo/blob/main/LICENSE"><picture><source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/github/inthhq/inrepo/license.svg?variant=outline&size=xs&mode=dark"><img src="https://shieldcn.dev/github/inthhq/inrepo/license.svg?variant=outline&size=xs&mode=light" alt="License"></picture></a>
